...
const StudentAssignmentDetail = () => {
  ...
  // Find if student has submitted this assignment (hardcoded student ID for demo)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Reload page to show submission details
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="mt-2 flex items-center gap-4">
                  <PlagiarismMeter score={submission.plagiarismScore || 0} size="large" />
                  <div>
